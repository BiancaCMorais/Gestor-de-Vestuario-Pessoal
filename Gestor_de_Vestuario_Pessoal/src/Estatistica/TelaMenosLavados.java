...
public class TelaMenosLavados extends JFrame{
    ...
    public TelaMenosLavados(Usuario usuario) {
    	setTitle("Itens menos lavados");
        ...
        JLabel titulo = new JLabel("Itens menos lavados ("+usuario.verNomeUsuario()+")");
        ...
        if(!usuario.verVestuario().isEmpty()) {
        	for (Map.Entry<String,Integer> entry : crescenteLavados.entrySet()) {
