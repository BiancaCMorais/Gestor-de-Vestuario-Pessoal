...
public class TelaMenosUsadosItens extends JFrame{
    ...
    public TelaMenosUsadosItens(Usuario usuario) {
    	setTitle("Itens menos usados");
        ...
        JLabel titulo = new JLabel("Itens menos usados ("+usuario.verNomeUsuario()+")");
        ...
        if(!usuario.verVestuario().isEmpty()) {
        	for (Map.Entry<String,Integer> entry : crescenteUsoItem.entrySet()) {
