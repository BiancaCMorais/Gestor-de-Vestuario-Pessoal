...
public class TelaMenosUsadosLooks extends JFrame{
    ...
    public TelaMenosUsadosLooks(Usuario usuario) {
    	setTitle("Looks menos usados");
        ...
        JLabel titulo = new JLabel("Looks menos usados ("+usuario.verNomeUsuario()+")");
        ...
        int linhaAtual=1;
        String texto;
        if(crescenteUsoLooks != null && !crescenteUsoLooks.isEmpty()) {
        	for (Map.Entry<String,Integer> entry : crescenteUsoLooks.entrySet()) {
