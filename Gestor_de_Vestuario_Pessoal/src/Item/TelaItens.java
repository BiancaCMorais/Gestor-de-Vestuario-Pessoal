...
public class TelaItens extends JFrame {
    ...
    public TelaItens(Usuario usuario) {
    	setTitle("Itens");
        ...
        JButton cadastrarBtn = new JButton("Cadastrar Novo Item");
        ...
        JLabel titulo = new JLabel("Itens ("+usuario.verNomeUsuario()+")");
        ...
        List<Item> itens = usuario.verVestuario();
        ...
        if(!itens.isEmpty()) {
        	for (Item item : itens) {
        	    JButton itemButton = new JButton(item.verNomeItem());
        	    ...
        	    itemButton.addActionListener(e -> {
        	        new TelaItem(usuario, item, new TelaItens(usuario)).setVisible(true);
        	        dispose();
        	    });
