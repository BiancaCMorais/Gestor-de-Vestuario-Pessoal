...
public class TelaUsarLook extends JFrame {
    ...
    public TelaUsarLook(Usuario usuario,Look look) {
        setTitle("Usar Item");
        ...
        JLabel titulo = new JLabel("Usar ("+look.verNomeLook()+")");
        ...
        eventoField.setFont(new Font("Tahoma", Font.PLAIN, 20));
        eventoField.setPreferredSize(new Dimension(200, 30));

        String labels = "Evento:";
        Component campos =  eventoField;
        ...
        usarBtn.addActionListener(e -> {
            ...
            look.usarLook(hojeLocal, evento);
